...
func NewTodoListAPI(spec *loads.Document) *TodoListAPI {
	return &TodoListAPI{
		...
		TodosGetHandler: todos.GetHandlerFunc(func(params todos.GetParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation TodosGet has not yet been implemented")
		}),

		// Applies when the "App-Token" header is set
		AppTokenAuthAuth: func(token string) (interface{}, error) {
...
type TodoListAPI struct {
	...
	// AppTokenAuthAuth registers a function that takes a token and returns a principal
	// it performs authentication based on an api key App-Token provided in the header
	AppTokenAuthAuth func(string) (interface{}, error)
...
func (o *TodoListAPI) Validate() error {
	...
	if o.AppTokenAuthAuth == nil {
		unregistered = append(unregistered, "AppTokenAuth")
	}
...
func (o *TodoListAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	...
	for name, scheme := range schemes {
		...
		case "AppTokenAuth":
			...
			result[name] = o.APIKeyAuthenticator(scheme.Name, scheme.In, o.AppTokenAuthAuth)
