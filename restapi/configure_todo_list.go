...
import (
	...
	"github.com/gavbaa/swagger-auth-test/restapi/operations"
	"github.com/gavbaa/swagger-auth-test/restapi/operations/todos"
...
func configureAPI(api *operations.TodoListAPI) http.Handler {
	...
	// Applies when the "App-Token" header is set
	...
	api.TodosGetHandler = todos.GetHandlerFunc(func(params todos.GetParams, principal interface{}) middleware.Responder {
		spew.Dump("principal", principal)
